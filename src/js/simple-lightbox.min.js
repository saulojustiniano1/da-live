              ...
              return (
                ...
                (e = [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      var e, o;
                      return this.options.captionSelector.startsWith('+')
                        ? ((o = this.options.captionSelector
                            .replace(/^\+/, '')
                            .trimStart()),
                          !(!(e = t.nextElementSibling) || !e.matches(o)) && e)
                        : this.options.captionSelector.startsWith('>')
                        ? ((o = this.options.captionSelector
                            .replace(/^>/, '')
                            .trimStart()),
                          t.querySelector(o))
                        : t.querySelector(this.options.captionSelector);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (t, e, o) {
                      ...
                      this.options.captions &&
                        ...
                        ((o =
                          null ==
                            (o = null != o ? o : this.options.captionHTML) || o
                            ? 'innerHTML'
                            : 'innerText'),
                        this.hide(this.domNodes.caption),
                        (this.domNodes.caption.style.width = e + 'px'),
                        (this.domNodes.caption[o] = t),
